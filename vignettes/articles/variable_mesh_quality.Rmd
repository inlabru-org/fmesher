...
# See INLA installation instructions on https://www.r-inla.org/download-install
library(INLA) # Only needed for inla.mesh.assessment()
library(inlabru)
library(ggplot2)
library(fmesher)
...
The `inla.mesh.assessment` function may also provide some insights:
