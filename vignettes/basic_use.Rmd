...
(mesh1 <- fm_mesh_1d(
  ...
  degree = 2 # need to fix fm_bary and fm_evaluator_1d to work correctly for degree = 2
))
```
...
# Construct an evaluator object. Function evaluation outside the interval
# is ill-defined.
