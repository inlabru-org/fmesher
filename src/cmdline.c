/*
  ...
  gengetopt --file-name=cmdline --conf-parser --unamed-opts=PREFIX --long-help --func-name=cmdline --no-handle-error 
...
const char *gengetopt_args_info_detailed_help[] = {
  ...
  "\nI/O options:",
  "      --io=SPEC                 I/O format specification (ascii/binary)\n                                  (possible values=\"aa\", \"ab\", \"ba\",\n                                  \"bb\" default=`bb')",
  "  -i, --ic=FILE                 Read input as matrix collections in the given\n                                  files",
  "  -o, --oc=FILE                 Write output as a matrix collection in the\n                                  given file",
  ...
  "      --collect-all             With --collect=-, load all matrices from the\n                                  input collections  (default=off)",
  ...
  "  -T, --input=NAME              Specify triangulation input data, default=s0.\n                                  A second name indicates a pre-existing\n                                  triangulation, as in -Ts0,tv0, further\n                                  indicates additional data point matrices.\n                                  Use - for tv0 to only supply additional\n                                  points.",
  "      --cutoff=DISTANCE         Treat points in the input data as unique only\n                                  if they are further apart than this value.\n                                  The vector 'idx' in the output gives the\n                                  resulting vertex index for each input point.\n                                  (default=`1.0e-12')",
  "      --spheretolerance=DISTANCE\n                                The tolerance for determining that the input\n                                  lies on a sphere.  (default=`1.0e-7')",
  ...
  "\nSMORG options:",
  "      --smorg                   Smorgasbord queries for a known triangulation.\n                                  Uses the given --input=s,tv directly, without\n                                  any filtering or refinement.",
  ...
  "      --sph0=ORDER              Calculate rotationally invariant spherical\n                                  harmonics up through order sph0\n                                  (default=`-1')",
...
const char *cmdline_io_values[] = {"aa", "ab", "ba", "bb", 0}; /*< Possible values for io. */
...
void
cmdline_print_detailed_help (void)
{
  int i = 0;
  print_help_common();
...
cmdline_release (struct gengetopt_args_info *args_info)
{
  ...
  free_multiple_string_field (args_info->ic_given, &(args_info->ic_arg), &(args_info->ic_orig));
  ...
  free_multiple_string_field (args_info->aniso_given, &(args_info->aniso_arg), &(args_info->aniso_orig));
...
cmdline_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  write_multiple_into_file(outfile, args_info->ic_given, "ic", args_info->ic_orig, 0);
  if (args_info->oc_given)
    write_into_file(outfile, "oc", args_info->oc_orig, 0);
  write_multiple_into_file(outfile, args_info->collect_given, "collect", args_info->collect_orig, 0);
  ...
  write_multiple_into_file(outfile, args_info->aniso_given, "aniso", args_info->aniso_orig, 0);
...
cmdline_required2 (struct gengetopt_args_info *args_info, const char *prog_name, const char *additional_error)
{
  ...
  if (check_multiple_option_occurrences(prog_name, args_info->ic_given, args_info->ic_min, args_info->ic_max, "'--ic' ('-i')"))
     error_occurred = 1;
  
  if (check_multiple_option_occurrences(prog_name, args_info->collect_given, args_info->collect_min, args_info->collect_max, "'--collect'"))
     error_occurred = 1;
  ...
  if (check_multiple_option_occurrences(prog_name, args_info->aniso_given, args_info->aniso_min, args_info->aniso_max, "'--aniso'"))
     error_occurred = 1;
                        ...
                        struct cmdline_params *params, const char *additional_error)
{
  ...
  while (1)
    {
      ...
      switch (c)
        ...
        case 'i':	/* Read input as matrix collections in the given files.  */
          ...
          if (update_multiple_arg_temp(&ic_list, 
              &(local_args_info.ic_given), optarg, 0, 0, ARG_STRING,
              "ic", 'i',
              additional_error))
            goto failure;
        ...
        case 'o':	/* Write output as a matrix collection in the given file.  */
          ...
          if (update_arg( (void *)&(args_info->oc_arg), 
               &(args_info->oc_orig), &(args_info->oc_given),
              &(local_args_info.oc_given), optarg, 0, 0, ARG_STRING,
              check_ambiguity, override, 0, 0,
              "oc", 'o',
              additional_error))
            goto failure;
        ...
        case 'B':	/* Handle triangulation boundary.  */
          ...
          if (update_multiple_arg_temp(&boundary_list, 
              &(local_args_info.boundary_given), optarg, 0, "boundary0", ARG_STRING,
              "boundary", 'B',
              additional_error))
            goto failure;
        ...
        case 'I':	/* Handle interior constraints.  */
          ...
          if (update_multiple_arg_temp(&interior_list, 
              &(local_args_info.interior_given), optarg, 0, "interior0", ARG_STRING,
              "interior", 'I',
              additional_error))
            goto failure;
        ...
        case 0:	/* Long option with no short option */
          ...
          if (strcmp (long_options[option_index].name, "dump-config") == 0)
          {
            ...
            if (update_arg( (void *)&(args_info->dump_config_arg), 
                 &(args_info->dump_config_orig), &(args_info->dump_config_given),
                &(local_args_info.dump_config_given), optarg, 0, 0, ARG_STRING,
                check_ambiguity, override, 0, 0,
                "dump-config", '-',
                additional_error))
              goto failure;
          ...
          else if (strcmp (long_options[option_index].name, "io") == 0)
          {
            ...
            if (update_arg( (void *)&(args_info->io_arg), 
                 &(args_info->io_orig), &(args_info->io_given),
                &(local_args_info.io_given), optarg, cmdline_io_values, "bb", ARG_ENUM,
                check_ambiguity, override, 0, 0,
                "io", '-',
                additional_error))
              goto failure;
          ...
          else if (strcmp (long_options[option_index].name, "collect") == 0)
          {
            ...
            if (update_multiple_arg_temp(&collect_list, 
                &(local_args_info.collect_given), optarg, 0, "-", ARG_STRING,
                "collect", '-',
                additional_error))
              goto failure;
          ...
          else if (strcmp (long_options[option_index].name, "collect-all") == 0)
          {
            ...
            if (update_arg((void *)&(args_info->collect_all_flag), 0, &(args_info->collect_all_given),
                &(local_args_info.collect_all_given), optarg, 0, 0, ARG_FLAG,
                check_ambiguity, override, 1, 0, "collect-all", '-',
                additional_error))
              goto failure;
          ...
          else if (strcmp (long_options[option_index].name, "cutoff") == 0)
          {
            ...
            if (update_arg( (void *)&(args_info->cutoff_arg), 
                ...
                &(local_args_info.cutoff_given), optarg, 0, "1.0e-12", ARG_DOUBLE,
                check_ambiguity, override, 0, 0,
                "cutoff", '-',
                additional_error))
              goto failure;
          ...
          else if (strcmp (long_options[option_index].name, "spheretolerance") == 0)
          {
          
          
            if (update_arg( (void *)&(args_info->spheretolerance_arg), 
                 &(args_info->spheretolerance_orig), &(args_info->spheretolerance_given),
          ...
          else if (strcmp (long_options[option_index].name, "aniso") == 0)
          {
            ...
            if (update_multiple_arg_temp(&aniso_list, 
                &(local_args_info.aniso_given), optarg, 0, 0, ARG_STRING,
                "aniso", '-',
                additional_error))
              goto failure;
  ...
  update_multiple_arg((void *)&(args_info->ic_arg),
    &(args_info->ic_orig), args_info->ic_given,
  ...
  update_multiple_arg((void *)&(args_info->ir_arg),
  ...
  update_multiple_arg((void *)&(args_info->aniso_arg),
    &(args_info->aniso_orig), args_info->aniso_given,
